...
module.exports = async client => {
  ...
  function getStreams(guild){
    ...
    if(!tempData.channelId || tempData.channelId == undefined || tempData.channelId.length < 17 || tempData.channelId.length > 21) return console.log(`NO TWITCH DATA (DCCHANNEL)`.magenta)
