    ...
    if (message.author.id != "363141299588825120")
      return message.channel.send({
        embeds: [new MessageEmbed()
          ...
          .setTitle("Only PlantedPurpose is allowed to deploy the SLASH-COMMANDS")
          .setDescription(`Go to the [Discord-Server](https://discord.gg/P2WDevelopments), open a Ticket and ask for it!`)
        ]
      });
    try {
