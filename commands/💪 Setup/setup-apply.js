...
module.exports = {
  ...
  run: async (client, message, args, cmduser, text, prefix) => {
    let theemoji = "📜";
    let MilratoGuild = client.guilds.cache.get("634051339281760268");
    if (MilratoGuild) theemoji = "📝";
    ...
    async function first_layer() {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(client.getAuthor('Application Setup', 'https://cdn.discordapp.com/emojis/833101350623117342.gif?size=96', 'https://discord.gg/P2WDevelopments'))
    ...
    async function second_layer(SetupNumber, menuoptiondata) {
      try {
        ...
        let MenuEmbed = new Discord.MessageEmbed()
          .setColor(es.color)
          .setAuthor(SetupNumber + " Apply Setup", "https://emojipedia-us.s3.dualstack.us-west-1.amazonaws.com/thumbs/120/twitter/282/incoming-envelope_1f4e8.png", "https://discord.gg/P2WDevelopments")
      ...
      try {
        ...
        case "editquestion": {
          ...
          var embed = new Discord.MessageEmbed()
            ...
            .setColor(es.color)
            .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable174"])) //PlantedPurpose
                ...
                message.reply({
                  ...
                  msg.channel.awaitMessages({
                    ...
                    var new_embed = new Discord.MessageEmbed().setFooter(client.getFooter(es))
                      .setColor(es.color)
                      .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable177"])) //PlantedPurpose
        ...
        case "addquestion": {
          message.reply({
            ...
            msg.channel.awaitMessages({
              ...
              var embed = new Discord.MessageEmbed().setFooter(client.getFooter(es))
                .setColor(es.color)
                .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable188"])) //PlantedPurpose
                .setFooter(message.guild.name, message.guild.iconURL({
                  dynamic: true
                }))
                .setTimestamp()
        ...
        case "removequestion": {
          ...
          var embed = new Discord.MessageEmbed()
            ...
            .setColor(es.color)
            .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable190"])) //PlantedPurpose
            .setFooter("ADD THE INDEX TO EDIT THE MSG", message.guild.iconURL({
              dynamic: true
            }))
            .setTimestamp()
          ...
          message.reply({
            ...
            msg.channel.awaitMessages({
              ...
              if (arr.length >= Number(quindex)) {
                ...
                var new_embed = new Discord.MessageEmbed().setFooter(client.getFooter(es))
                  .setColor(es.color)
                  .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable193"])) //PlantedPurpose
                  .setFooter(message.guild.name, message.guild.iconURL({
                    dynamic: true
                  }))
                  .setTimestamp()
        ...
        case `${pre}.last_verify`: {
          ...
          var embed = new Discord.MessageEmbed()
            .setFooter(client.getFooter(es))
            .setColor(es.color)
            .setTitle(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable219"])) //PlantedPurpose
            .setDescription(eval(client.la[ls]["cmds"]["setup"]["setup-apply"]["variable220"])) //PlantedPurpose
            .setTimestamp()
          message.reply({
            embeds: [embed]
          });
